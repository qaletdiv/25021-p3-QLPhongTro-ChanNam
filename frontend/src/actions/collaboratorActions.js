...
export async function addCollaborator(buildingId, email, password) {
  return serverFetch(`/buildings/${buildingId}/collaborators`, { method: 'POST', body: JSON.stringify({ email, password }) });
}
