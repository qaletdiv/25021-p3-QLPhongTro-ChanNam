...
const theme = createTheme({
  palette: {
   ...
   typography: {
    ...
    subtitle2: { fontWeight: 600, fontSize: "0.75rem", color: "#64748b", letterSpacing: "normal" },
    body1: { fontSize: "0.875rem", letterSpacing: "normal" },
    body2: { fontSize: "0.75rem", letterSpacing: "normal" },
    button: { fontWeight: 700, fontSize: "0.75rem", textTransform: "none", letterSpacing: "normal" },
    caption: { fontSize: "0.6875rem", letterSpacing: "normal" },
